...
JobCoin.prototype.refund = function(record, onResult, onError) {
  this.send(config.get('mixer.address'), record.fromAddress, record.amount, onResult, onError)
}
...
JobCoin.prototype.pay = function(address, amount, onResult, onError) {
  this.send(config.get('mixer.address'), address, amount, onResult, onError)
}
