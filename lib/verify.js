...
const mixerAddr = config.get('mixer.address')

function Verify(record) {
  this.record = record
}

function onSuccess(code, data) {
...
Verify.prototype.poll = function() {
  jobcoin.getAddressInfo(this.record.fromAddress, onSuccess.bind(this), onError.bind(this))
}
